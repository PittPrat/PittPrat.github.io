...
export default function Hero() {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ref={ref}
        className={cn("text-center z-10 px-4 transition-opacity duration-1000", inView ? "opacity-100" : "opacity-0")}
      >
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
          <span className="block mb-2">Hi, I'm</span>
          <span className="text-primary text-glow">Prathik Pittala</span>
          <span
            className={cn("inline-block w-1 h-12 bg-primary ml-1 animate-blink", isTypingComplete ? "" : "hidden")}
          ></span>
        </h1>
