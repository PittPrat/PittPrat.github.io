      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mt-16">
        ...
        <div>
          ...
          <p className="text-muted-foreground mb-6">
            Senior Software Engineer with 7 years of industry experience and advanced ML expertise from Master's
            education at University of Washington. Skilled in cloud architecture, AI/ML and Full-Stack software
            implementation with proven success delivering high-performance solutions for global organizations, combining
            technical expertise with product vision to align engineering excellence with strategic objectives.
          </p>
          <p className="text-muted-foreground mb-6">
